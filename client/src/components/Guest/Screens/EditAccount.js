...
import { setAccount, getCurrentAccount } from "../../../redux/actions/Guest/accountActions";
...
function EditAccount(props) {
    ...
    useEffect(() => {
        if(props.account.account)
        {
            ...
            account.city  = !isEmpty(account.city) ? account.city : '';
            account.phoneNo = !isEmpty(account.phoneNo) ? account.phoneNo : '';
            account.zipCode = !isEmpty(account.zipCode) ? account.zipCode : '';
            account.country =  !isEmpty(account.country) ? account.country : '';
...
export default connect(mapStateToProps, {setAccount,getCurrentAccount})(EditAccount);
