...
import {setAdminProfile, getAdminProfile, deleteAdminProfile} from "../../../redux/actions/Admin/adminProfileActions";
                        ...
                        <Card style={{padding: "60px", margin: "10px", marginTop: "100px"}}>

                            {
                                props.adminProfile.companyProfile !== null ? (
                                    <React.Fragment>
                                        <Typography variant="h6" style={{padding: '20px', letterSpacing: "2px", fontWeight: "bold"}}>
                                            Hello {props.adminAuth.user.username} You already Have Your Own Company with the name of {props.adminProfile.companyProfile.companyName}
                                            <br /> 
                                            Edit, Create product for your company or Create your Tieup company by clicking on below buttons
                                        </Typography>
                                        <Button 
                                        ...
                                        <Button 
                                            ...
                                            style={{margin: '18px', letterSpacing: "2px"}}
                                        >
                                            CREATE TIEUP COMPANY
                                        </Button>
                                        <Button 
                                            href="/admin/alltieups"
                                            variant="outlined" 
                                            color="secondary" 
                                            style={{margin: '18px', letterSpacing: "2px"}}
                                        >
                                            CHECK ALL TIEUP'S COMPANY
                                        </Button>
                                    </React.Fragment>
                                ) : (
                                    <React.Fragment>
...
AdminProfile.propTypes = {
    ...
    deleteAdminProfile: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {setAdminProfile,getAdminProfile,deleteAdminProfile,setAdminLogout} )(AdminProfile);
