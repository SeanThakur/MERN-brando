...
import { setAdminLogin } from "../../../../redux/actions/authAdminActinons";
...
function ALogin(props) {
  ...
  const handleSubmit = (e) => {
    ...
    props.setAdminLogin(newUser);

  }

  useEffect(() => {
    if(props.adminAuth.isAdmin === true)
    {
      window.location.href = "/admin/profile"
    }
  }, [props.adminAuth.isAdmin])
...
export default connect(mapStateToProps, {setAdminLogin})(ALogin);