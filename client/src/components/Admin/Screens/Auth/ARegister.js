...
import { getAdminRegister } from "../../../../redux/actions/authAdminActinons";
...
function ARegister(props) {
  ...
  const handleSubmit = (e) => {
    ...
    // });
    props.getAdminRegister(newUser, window.location);
  }
        ...
        <form className={classes.form} onSubmit={handleSubmit}>
          ...
          <Grid container justify="flex-end">
            ...
            <Grid item sm={5} xs={12}>
              <Link color="secondary" href="/#" variant="body2" className={classes.forget}>
                Forget Password?
              </Link>
            </Grid>
          </Grid>
...
ARegister.propTypes = {
  getAdminRegister: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {getAdminRegister})(ARegister);